...
from pyp.cli.ingest.commands.stock_prices import IngestStocksPricesCommand
...
@ingest_app.command(name="stock-prices", help="Ingest stock prices.")
def stocks_prices(
    start_date: Annotated[
        Optional[datetime],
        typer.Option(
    ...
    provider: Annotated[
        ...
        typer.Option(
            ...
            "-p",
            metavar="PROVIDER",
            help="The provider to use for the prices."
        )
    ] = "yfinance"
) -> None:
    IngestStocksPricesCommand(
        engine,
        start_date,
        end_date,
        monikers,
